...
titlelabel["Text"] = " FE R15 BY ZIKRI Animation Player"
...
local animations = {
	...
	{name = "Coco Fly", id = 15698511500, speed = 1, timepos = 0},
	{name = "Take The L", id = 78653596566468, speed = 1, timepos = 0},
	{name = "PushUp", id = 108890286629805, speed = 1, timepos = 0},
	{name = "Flip", id = 116728799092339, speed = 1, timepos = 0},
	{name = "HeadKick", id = 96749553415348, speed = 1, timepos = 0},
	{name = "YoungBlud", id = 15610015346, speed = 1, timepos = 0},
	{name = "HugoCar", id = 17360720445, speed = 1, timepos = 0},
